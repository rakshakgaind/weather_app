...
import com.project.weather.databinding.FragmentSearchBinding
import com.project.weather.model.IViewProgress
import com.project.weather.model.MainRepository
import com.project.weather.model.SearchAdapter
import com.project.weather.model.WeatherApiResult
import com.project.weather.rest.WeatherRetrofitConfig
import com.project.weather.viewmodel.SearchViewModel
import com.project.weather.viewmodel.SearchViewModelFactory
...
//        requireActivity().supportFragmentManager.beginTransaction().replace(R.id.fragment,ResultFragment()).addToBackStack(null).commit()
        val action = SearchFragmentDirections.actionSearchFragmentToResultFragment(weather)
